      ...
      appBar: AppBar(
        ...
        bottom: PreferredSize(preferredSize: const Size.fromHeight(92), child: Padding(
          ...
          child: Column(children: [
            TextField(onChanged: (s) => ref.read(searchQueryProvider.notifier).state = s, decoration: const InputDecoration(prefixIcon: Icon(Icons.search), hintText: 'Search name or district')),
